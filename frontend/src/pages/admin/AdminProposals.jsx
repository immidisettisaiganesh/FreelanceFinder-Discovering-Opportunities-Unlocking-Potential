...
export default function AdminProposals() {
  ...
  return (
    <div className="fade-in">
      <h4 className="fw-bold mb-4">All Proposals</h4>
      {loading ? <div className="text-center py-5"><div className="spinner-border text-primary"/></div> :
        <div className="sb-card overflow-hidden">
          <table className="table mb-0">
            <thead className="table-light"><tr><th>Description</th><th>Price</th><th>Duration</th><th>Status</th><th>Date</th></tr></thead>
            <tbody>
              {proposals.map(p => (
                <tr key={p._id}>
                  <td><div style={{maxWidth:300}}>{p.description?.substring(0,80)}...</div></td>
