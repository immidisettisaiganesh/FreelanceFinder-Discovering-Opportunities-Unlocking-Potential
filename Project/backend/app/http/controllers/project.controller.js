...
class ProjectController extends Controller {
  async addNewProject(req, res) {
    ...
    if (!project?._id)
      throw createHttpError.InternalServerError("Project not registered.");
  ...
  async findProjectById(id) {
    if (!mongoose.isValidObjectId(id))
      throw createHttpError.BadRequest("The project ID sent is not valid.");
  ...
  async changeProjectStatus(req, res) {
    ...
    let message = "Project has been closed.";
  ...
  async deleteProject(req, res) {
    ...
    if (project.freelancer)
      throw createHttpError.BadRequest("Project cannot be deleted.");
